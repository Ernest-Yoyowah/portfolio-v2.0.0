...
const techStack = ["React", "TypeScript", "Node.js", "Golang", "Next.js"];

export function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center pt-14 pb-20"
    >
      <div className="container-max section-padding">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-foreground leading-[1.05] mb-6">
            Ernest Yoyowah
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground font-light mb-8 leading-relaxed">
            Software Engineer — Payments & Systems
          </p>
          ...
          <div className="flex flex-wrap items-center gap-3 mb-12">
            <Link
              href="/work"
              className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-md bg-foreground text-background text-sm font-medium hover:opacity-90 transition-opacity"
            >
              View Work
              <ArrowRight
                size={14}
            ...
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md border border-border text-foreground text-sm font-medium hover:bg-muted transition-colors"
            >
              View Projects
            </Link>
          </div>
