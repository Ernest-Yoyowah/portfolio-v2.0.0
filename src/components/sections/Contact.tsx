...
const contactLinks = [
  ...
  {
    label: "Medium",
    handle: "ernestyoyowah.medium.com",
          ...
          <div className="space-y-2 mb-8">
            {contactLinks.map(({ label, handle, href, Icon }) => (
              <a
                ...
                className="group flex items-center justify-between p-4 border border-border rounded-lg hover:border-foreground/20 hover:bg-muted/30 transition-colors"
              >
