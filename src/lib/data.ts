...
export const projects = [
  ...
  },
  {
    id: "pulsemidi",
    title: "PulseMIDI",
    subtitle: "MIDI Diagnostics & Routing",
    description:
      "Native macOS MIDI diagnostics and monitoring platform built with Rust and CoreMIDI. Realtime signal inspection, device management, and virtual port routing. Supports Intel and Apple Silicon, with standalone and plugin distributions (VST3, CLAP).",
    longDescription:
      "PulseMIDI is a native macOS application for professional-grade MIDI signal monitoring, device enumeration, and port routing. Built with Rust for direct CoreMIDI framework access and Tauri as the native application shell, with a React UI for realtime visualisation. Targets Intel and Apple Silicon Macs. Distributed as a standalone application and as VST3 and CLAP plugins.",
    stack: ["Rust", "Tauri", "React", "TypeScript", "CoreMIDI"],
    category: "Music Technology",
    status: "Active Development",
    highlights: [
      "CoreMIDI integration via Rust — device enumeration, event capture, virtual port creation",
      "Realtime MIDI signal visualisation and message inspection",
      "MIDI device management and routing configuration",
      "Native Intel and Apple Silicon support",
      "Standalone application and VST3 / CLAP plugin distributions",
    ],
  ...
  },
  {
    id: "pulsepad",
    title: "PulsePad",
    subtitle: "Creative Performance System",
    description:
      "Performance pad controller system for live worship and creative musicians — MIDI, audio routing, and real-time performance controls.",
    longDescription:
      "Next-generation performance tool merging hardware pad control with software intelligence. Designed for worship musicians and live performers.",
    stack: ["Rust", "Tauri", "React", "TypeScript", "CoreMIDI", "CoreAudio"],
    category: "Music Technology",
    status: "Coming Soon",
    highlights: [
      "Intelligent pad mapping engine",
      "Live performance mode",
      "Setlist & song cue management",
      "DAW integration",
    ],
...
export const musicTechCapabilities = [
  {
    ...
    description:
      "CoreMIDI-based event capture, virtual port creation, MIDI device enumeration, and low-latency message routing. PulseMIDI implements this layer with a Rust backend communicating directly with the macOS CoreMIDI framework.",
    tags: ["CoreMIDI", "Rust", "Virtual Ports", "Device Enumeration"],
  },
  {
    title: "Native Desktop Music Software",
    description:
      "macOS native application development targeting Intel and Apple Silicon. Standalone and plugin distribution formats — VST3 and CLAP — using Tauri as the native application shell with a React frontend layer.",
    tags: ["Tauri", "Rust", "VST3", "CLAP", "Intel", "Apple Silicon"],
  },
  {
...
export const articles = [
  ...
  {
    id: "rust-midi",
    title: "Building MIDI Tools with Rust and CoreMIDI",
    excerpt:
      "A practical guide to accessing macOS CoreMIDI from Rust — device enumeration, port routing, and real-time message handling.",
    category: "Music Technology",
    readTime: "10 min read",
    date: "Coming Soon",
    tags: ["Rust", "MIDI", "macOS"],
  },
  {
